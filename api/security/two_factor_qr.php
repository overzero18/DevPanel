...
if ($qrencode === '')
{
    echo '<svg xmlns="http://www.w3.org/2000/svg" width="220" height="220"><rect width="100%" height="100%" fill="#111827"/><text x="50%" y="48%" fill="#94a3b8" text-anchor="middle" font-family="sans-serif" font-size="13">QR no disponible</text><text x="50%" y="58%" fill="#64748b" text-anchor="middle" font-family="sans-serif" font-size="11">Instala qrencode</text></svg>';
    exit;
}
